import{_ as i,M as t,p as l,q as r,N as n,V as o,a1 as u,R as e,t as a}from"./framework-5866ffd3.js";const p={},d=u(`<h1 id="floating-point-comparison" tabindex="-1"><a class="header-anchor" href="#floating-point-comparison" aria-hidden="true">#</a> Floating Point Comparison</h1><p><code>float</code>s have limited precision and are unable to exactly represent some values. Rounding errors accumulate with repeated computation, and numbers expected to be equal often differ slightly.</p><p>As a result, it is common advice to not use an exact equality comparison (<code>==</code>) with floats.</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt;&gt;&gt; a, b, c = 1e-9, 1e-9, 3.33e7
&gt;&gt;&gt; (a + b) + c == a + (b + c)
False
