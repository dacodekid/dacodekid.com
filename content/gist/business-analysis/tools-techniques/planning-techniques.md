...
A: To provide a financial breakdown of the project scope and budget
B: To act as a prioritized list of deliverables that need to be completed for a solution
C: To serve as a legal document outlining project deliverables and timelines
D: To focus exclusively on the technical specifications of the project scope
Answer: B
...
A: By focusing on the financial planning of the project scope and budget
B: By detailing near-term work and planning future work at a higher level
C: By serving as a legal planning document for the project scope
...
B: It prioritizes user stories for visualization and planning.
...
A: To provide a financial overview of the project scope and budget for each phase
B: To divide the project scope into manageable parts for scheduling and planning
C: To serve as a legal contract for project deliverables and timelines
D: To focus on the technical architecture of the project scope
Answer: B
...
A: They ensure financial accuracy in project planning and execution.
B: They offer structured methods to manage project aspects efficiently.
C: They focus on the legal aspects of project planning and execution.
D: They emphasize the technical precision in project planning and execution.
Answer: B
...
A: To provide a financial overview of the project scope and budget
B: To serve as a dynamic ordered list of solution items (e.g., user stories, requirements)
C: To serve as a legal document for project deliverables and timelines for each iteration
D: To focus exclusively on the technical specifications of the project scope
Answer: B
...
B: Financially Detailed, Efficient, Economic, Planned Appropriately
...
B: By helping refine the backlog with item management
...
D: By emphasizing the technical interdependencies of items in the backlog
Answer: B
...
C: To serve as a legal framework for project planning and execution
D: To focus solely on the technical planning of a project and not on business aspects
Answer: B
...
A: By focusing on the financial aspects of the project scope and budget
B: Enables detailed planning for current tasks, keeping future tasks high-level
...
B: Gradually details project plans as more info emerges.
...
A: By providing a financial forecast for each release of the project
B: By planning at the release level, specifying features for current or upcoming releases
C: By serving as a legal document for each release of the project scope
...
A: To provide a financial analysis for each phase of the project life cycle
B: To aid in detailed near-term planning and prioritize upcoming release features
C: To focus on the legal compliance of project planning and execution
...
B: To establish a clear hierarchy of team roles and responsibilities for the project.
C: To arrange and sequence user stories for better understanding and development.
D: To serve as a legal documentation for project deliverables and timelines.
Answer: C
...
A: A detailed technical specification for each feature or function, often referred to as the Minimum Marketable Features (MMF).
B: Core capabilities required for the initial release, similar to the Minimum Viable Product (MVP).
C: The project's marketing and sales strategies for each release.
...
B: As the essential end-to-end functionalities for solution viability.
...
B: It shows releases as horizontal lines, grouping by team capacity and dates.
...
A: By providing a template for legal contracts between the organization and its clients or customers.
B: By offering a structured approach to identify gaps in user capabilities and inform rigorous analysis.
C: It is used exclusively for external stakeholder communication and engagement.
D: By detailing the technology stack to be used in product development and delivery.
Answer: B
...
A: To provide a detailed financial overview of the project scope and budget
...
A: By providing a financial breakdown of the project scope and budget for each phase
B: By linking estimates, priorities, dependencies, and constraints to WBS work packages
C: By serving as a legal guideline for project scheduling and planning
D: By focusing on the technical sequencing of project tasks and activities
Answer: B
...
B: To accurately define, sequence, and estimate business analysis tasks in the WBS
C: To focus on the legal aspects of business analysis tasks in the WBS
D: To emphasize the technical development of business analysis components in the WBS
Answer: B
...
A: To provide a financial re-evaluation of the project scope and budget at each phase
B: To adapt to changes and align with project objectives at defined project life cycle points
C: To serve as a legal document that needs regular updating and revision at each phase
D: To focus on the technical adjustments in the project scope at each phase
Answer: B
...
A: By providing a financial plan for business analysis activities and tasks
B: By clarifying responsibilities and aiding in resource allocation, estimation, and scheduling
C: By serving as a legal document for business analysis tasks and activities
D: By focusing on the technical aspects of business analysis tasks
Answer: B
